...
class AirportDepartureController extends Controller
{
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function show($airport_id, $departure_id)
    {
        return Flight::findOrFail($departure_id);
    }
    ...
    public function store(Request $request, Airport $airport)
    {
        ...
        $airport->departures()->save($flight);
